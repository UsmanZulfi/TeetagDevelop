...
export declare type RoleAccess<Routes extends string[]> = {
    [index: string]: {
        grantedRoutes: Routes;
        accessRoute: Routes[number];
    };
};
export declare type NextShieldProps<PrivateRoutesList extends string[], PublicRoutesList extends string[]> = {
    /**
