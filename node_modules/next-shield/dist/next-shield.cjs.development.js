...
function ComponentShield(props) {
  ...
  if (RBAC) return React__default.createElement(React__default.Fragment, null, showForRole === userRole ? children : null);
  if (showIf) return React__default.createElement(React__default.Fragment, null, children);
...
function NextShield(_ref) {
  ...
  if ((isLoading || !isAuth) && pathIsPrivate || (isLoading || isAuth) && pathIsPublic || (isLoading || userRole) && !pathIsAuthorized && !pathIsHybrid || isLoading && pathIsHybrid) return React__default.createElement(React__default.Fragment, null, LoadingComponent);
  return React__default.createElement(React__default.Fragment, null, children);
}

exports.ComponentShield = ComponentShield;
exports.NextShield = NextShield;
//# sourceMappingURL=next-shield.cjs.development.js.map
